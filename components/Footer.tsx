    ...
    <footer className="bg-black py-10 text-white text-center">
      <div className="container mx-auto px-4">
        ...
        <div className="flex justify-center space-x-6 mb-6">
          <a href="#" className="text-gray-400 hover:text-bea-tek-magenta transition duration-300" aria-label="Lien Facebook">
          ...
          <a href="#" className="text-gray-400 hover:text-bea-tek-magenta transition duration-300" aria-label="Lien Instagram">
            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              {/* Instagram Icon */}
          ...
          <a href="#" className="text-gray-400 hover:text-bea-tek-magenta transition duration-300" aria-label="Lien YouTube">
            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              {/* YouTube Icon */}
